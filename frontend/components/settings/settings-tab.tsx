...
export default function SettingsTab({
  ...
  const Tab = ({ children }: { children: React.ReactNode }) => (
    <ThemedView>
      <ThemedView style={[styles.settingsTab, viewProps]}>
        ...
        {switchValue !== null && (
          <Switch
            ...
            style={styles.switch}
            trackColor={{ false: "gray", true: "#4B9CD3" }}
          />
        )}
        ...
        {subtext !== null && (
          <ThemedText style={[styles.subtext]} type="defaultItalic">
            {subtext}
          </ThemedText>
        )}
        ...
        {dropdownValues !== null && (
          <Dropdown
            ...
            style={[
              ...
              styles.dropdown,
              { backgroundColor: themeBackgroundColor, borderRadius: 10 },
            ]}
          />
        )}
        {expand && (
      ...
      {expand && expanded && (
        <ThemedView style={styles.expandedTab}>{children}</ThemedView>
      )}
    </ThemedView>
  );
  ...
  return route === null && link === null ? (
    ...
    <Link
      href={{
        pathname: (link !== null ? link : route !== null ? route : "/") as any,
      }}
      asChild
    >
      <Pressable>
