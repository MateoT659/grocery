...
import {
  DeleteGroceryListResponseDto,
  GenerateGroceryListDto,
  GenerateGroceryListResponseDto,
  GroceryList,
  PostGroceryListResponseDto,
  PutGroceryListResponseDto,
...
export async function getGroceryListById(
  ...
  const response = await fetch(
    `${GROCERY_LIST_API_URL}/get-grocery-list/${groceryListId.toString()}`,
  );
  return await response.json();
}

export async function setGroceryListById(
  groceryListId: string,
  updatedList: GroceryList,
): Promise<PutGroceryListResponseDto> {
  const response = await fetch(
    `${GROCERY_LIST_API_URL}/put-grocery-list/${groceryListId.toString()}`,
    {
      method: "PUT",
      headers: {
...
export async function addGroceryList(
  newList: GroceryList,
): Promise<PostGroceryListResponseDto> {
...
export async function deleteGroceryListById(
  groceryListId: string,
): Promise<DeleteGroceryListResponseDto> {
  const response = await fetch(
    `${GROCERY_LIST_API_URL}/delete-grocery-list/${groceryListId.toString()}`,
    {
      method: "DELETE",
    },
  );
